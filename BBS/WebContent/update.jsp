...
<body>
 ...
 <%  
  ...
  %>
	...
	<div class="container">
		<div class="row">
		<form method="post" action="updateAction.jsp?bbsID=<%= bbsID %>&pageNumber=<%= pageNumber%>">
			<table class="table table-striped" style="text-align: center; border: 1px soild #dddddd">
				...
				<tbody>
					...
					<tr>
						<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="65535" style="height:350px;"><%= bbs.getBbsContent() %></textarea></td>
					</tr>
				</tbody>			
			</table>
