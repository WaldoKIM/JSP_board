...
<!-- 행정안전부 로고 및 타이틀 시작 -->
<div id="logoarea" class="fleft bgred">
...
<div id="nia_logo">
 ...
 -->
<div id="project_title" class="toptest2"><span class="maintitle">★표준★<br>프레임워크 <strong>샘플 홈페이지 </strong></span>
...
<div class="header_login fclear">
    ...
    <ul class="login_bg_area loginbox">
