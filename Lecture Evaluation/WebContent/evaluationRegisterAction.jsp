...
<%
	...
	if(request.getParameter("difficultyGrade") != null) {
		difficultyGrade = (String) request.getParameter("difficultyGrade");
	}
	...
	if (lectureName == null || professorName == null || lectureYear == 0 || semesterDivide == null ||
			...
			creditScore == null || difficultyGrade == null || lectureScore == null ||
		...
		System.out.println(difficultyGrade);
		...
		int result = evaluationDAO.write(new EvaluationDTO(0, userID, lectureName, professorName, lectureYear,
				...
				totalScore, creditScore, difficultyGrade, lectureScore, 0));
		if (result == -1) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
